...
using NYB.DeviceManagementSystem.View.Models;

namespace NYB.DeviceManagementSystem.View.Filters
{
        ...
        private class SimpleMembershipInitializer
        {
            public SimpleMembershipInitializer()
            {
                ...
                try
                {
                    ...
                    WebSecurity.InitializeDatabaseConnection("DeviceMgmtForDB", "UserProfile", "UserId", "UserName", autoCreateTables: true);
                }
                catch (Exception ex)
                {
